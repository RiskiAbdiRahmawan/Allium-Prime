...
<body class="w-screen h-screen" style="background-image: url({{ asset("images/orion.jpg") }});background-size:cover;background-position:center">
    <section class="">
  <div class="flex flex-col items-center justify-center px-6 py-10 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full max-w-md bg-white/80 backdrop-blur-md rounded-lg shadow-md dark:bg-gray-800/70">
          <div class="p-8 space-y-4 md:space-y-6 sm:p-8">
              <h1 class="text-xl font-bold leading-tight tracking-tight text-white dark:text-white text-center">
              ...
              <form class="space-y-4 md:space-y-6" action="{{ route('login') }}" method="POST">
                ...
                @enderror
                  <button type="submit" class="w-full text-white bg-navyblue hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign in</button>
                  <p class="text-sm font-light text-white dark:text-gray-400">
                      Don't have an account yet? <a href="#" class="font-medium text-white hover:underline dark:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
