<aside class="max-w-62.5 h-screen ease-nav-brand z-990 fixed inset-y-0 flex flex-col justify-between w-full overflow-hidden rounded-2xl border-0 bg-white p-0 antialiased shadow-none xl:left-0 xl:translate-x-0 xl:bg-transparent">      <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
          ...
          <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Allium Prime</span>
        </a>
      </div>
        ...
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/virtual-reality.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Laporan Trasaction Stock</span>
            </a>
          </li>
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="../pages/rtl.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Prediksi Permintaan</span>
            </a>
          </li>
